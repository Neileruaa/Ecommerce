 ...
 */
final class Version20181111140035 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE panier_produits (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, panier_id INT NOT NULL, quantity INT DEFAULT NULL, INDEX IDX_2468D6FEF347EFB (produit_id), INDEX IDX_2468D6FEF77D927C (panier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE panier_produits ADD CONSTRAINT FK_2468D6FEF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
